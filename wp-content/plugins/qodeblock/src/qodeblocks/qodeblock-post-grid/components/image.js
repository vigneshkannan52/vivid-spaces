			...
			<Fragment>
				...
				>
					...
					{	/* If we don't have the selected image size, show a warning */
						...
						<Fragment>
							<div className={ 'qb-post-grid-no-image-icon' }>
								<Dashicon
									icon={ 'warning' }
								/>
							</div>
							...
							<Placeholder
								className={ 'qb-post-grid-no-image-placeholder' }
							>
								<Dashicon icon={ 'info' } />
								<div className="components-placeholder__label">
									{ __( 'There is no image generated for the selected image size, so a fallback image size is being used.', 'qodeblock' ) }
								</div>
								<div className="qb-post-grid-image-help"><a target="_blank" rel="noreferrer noopener" aria-label={ __( 'Learn more about image sizes (opens in a new tab)', 'qodeblock' ) } href="#">{ __( 'Learn more ', 'qodeblock' ) }<span>&rarr;</span></a></div>
							</Placeholder>
						</Fragment>
					}
				</div>
