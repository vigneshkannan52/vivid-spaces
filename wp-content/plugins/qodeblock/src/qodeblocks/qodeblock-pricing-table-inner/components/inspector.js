...
export default class Inspector extends Component {
	...
	render() {
		...
		<InspectorControls key="inspector">
			<PanelBody>
				<RangeControl
					label={ __( 'Pricing Column Padding', 'qodeblock' ) }
					value={ padding }
				...
				/>
				<RangeControl
					label={ __( 'Pricing Column Border', 'qodeblock' ) }
					value={ borderWidth }
				...
				/>
				<RangeControl
					label={ __( 'Pricing Column Border Radius', 'qodeblock' ) }
					value={ borderRadius }
			...
			{ ( borderWidth > 0 ) && (
				<PanelColorSettings
					title={ __( 'Pricing Column Border Color', 'qodeblock' ) }
					initialOpen={ false }
					colorSettings={ [ {
						value: borderColor,
						onChange: onChangeBorderColor,
						label: __( 'Border Color', 'qodeblock' ),
					} ] }
				>
				</PanelColorSettings>
				) }
			<PanelColorSettings
				title={ __( 'Pricing Column Background Color', 'qodeblock' ) }
				initialOpen={ false }
				colorSettings={ [ {
