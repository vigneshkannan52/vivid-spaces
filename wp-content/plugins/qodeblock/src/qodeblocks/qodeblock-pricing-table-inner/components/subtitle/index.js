/**
 * BLOCK: Qodeblock Pricing Table - Subtitle Component
 */
...
// Register the block
registerBlockType( 'qodeblock/qb-pricing-table-subtitle', {
	title: __( 'Product Subtitle', 'qodeblock' ),
	description: __( 'Adds a product subtitle component with schema markup.', 'qodeblock' ),
	icon: iconEl,
	category: 'qodeblock',
	...
	save: function( props ) {
		...
		const className = classnames( {
			...
			'qb-pricing-table-subtitle': true,
