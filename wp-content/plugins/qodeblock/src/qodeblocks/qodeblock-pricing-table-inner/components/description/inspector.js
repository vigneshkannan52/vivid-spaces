...
class Inspector extends Component {
	...
	render() {
		...
		// Border styles
		const borderStyles = [
			{ value: 'qb-list-border-none', label: __( 'None' ) },
			{ value: 'qb-list-border-solid', label: __( 'Solid' ) },
			{ value: 'qb-list-border-dotted', label: __( 'Dotted' ) },
			{ value: 'qb-list-border-dashed', label: __( 'Dashed' ) },
		];
		...
		<InspectorControls key="inspector">
			<PanelBody title={ __( 'Text Settings', 'qodeblock' ) }>
				<FontSizePicker
				...
				/>
				<SelectControl
					label={ __( 'List Border Style', 'qodeblock' ) }
					value={ borderStyle }
				...
				/>
				{ ( borderStyle != 'qb-list-border-none' ) && (
					<RangeControl
						label={ __( 'List Border Width', 'qodeblock' ) }
						value={ borderWidth }
				...
				{ ( borderStyle != 'qb-list-border-none' ) && (
					<PanelRow>
						<BaseControl
							label={ __( 'List Border Color', 'qodeblock' ) }
						>
							<ColorPalette
								initialOpen={ false }
								value={ borderColor }
			...
			<PanelBody
				title={ __( 'Padding Settings', 'qodeblock' ) }
				initialOpen={ false }
			>
				<Padding
					// Top padding
			...
			<PanelColorSettings
				title={ __( 'Color Settings', 'qodeblock' ) }
				initialOpen={ false }
				colorSettings={ [
					{
