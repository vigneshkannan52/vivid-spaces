	...
	render() {
		...
		let mailingListProviders = {
			'mailchimp': {
				...
				lists: [
					{
						label: __( 'Select a list', 'qodeblock' ),
						value: '',
					}
				],
			},
		...
		qodeblock_newsletter_block_vars.mailingListProviders.mailchimp.lists.map( ( item ) =>
		...
		return (
			<InspectorControls>
				...
				<PanelBody
					title={ __( 'Newsletter', 'qodeblock' ) }
					initialOpen={ attributes.mailingList ? false : true }
				>
					<SelectControl
						label={ __( 'Mailing List', 'qodeblock' ) }
						help={ __( 'The list people will be subscribed to.', 'qodeblock' ) }
					...
					<TextControl
						type="string"
						label={ __( 'Success Message', 'qodeblock' ) }
						help={ __( 'The message shown when people successfully subscribe.', 'qodeblock' ) }
				...
				>
					<Padding
						...
						paddingEnable={ true }
						paddingTitle={ __( 'Block Padding', 'qodeblock' ) }
						paddingHelp={ __( 'Adjust the padding applied to the inside of the block.', 'qodeblock' ) }
					...
					<Margin
						...
						marginTopLabel={ __( 'Block Margin Top', 'qodeblock' ) }
						...
						marginBottomLabel={ __( 'Block Margin Bottom', 'qodeblock' ) }
					...
					colorSettings={ [
						{
							...
							label: __( 'Block Background Color', 'qodeblock' ),
						},
						{
							value: textColor.color,
							onChange: setTextColor,
							label: __( 'Block Text Color', 'qodeblock' ),
						},
						{
