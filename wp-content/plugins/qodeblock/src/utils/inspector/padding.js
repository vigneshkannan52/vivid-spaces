...
export default function Padding( props ) {
	...
	return (
		<Fragment>
			{ paddingEnable && (
				<RangeControl
					label={ paddingTitle ? paddingTitle : __( 'Padding', 'qodeblock' ) }
			...
			{ paddingEnableTop && (
				<RangeControl
					label={ __( 'Padding Top', 'qodeblock' ) }
					value={ paddingTop }
					min={ paddingTopMin }
					max={ paddingTopMax }
			...
			{ paddingEnableRight && (
				<RangeControl
					label={ __( 'Padding Right', 'qodeblock' ) }
					value={ paddingRight }
					min={ paddingRightMin }
					max={ paddingRightMax }
			...
			{ paddingEnableBottom && (
				<RangeControl
					label={ __( 'Padding Bottom', 'qodeblock' ) }
					value={ paddingBottom }
			...
			{ paddingEnableLeft && (
				<RangeControl
					label={ __( 'Padding Left', 'qodeblock' ) }
					value={ paddingLeft }
					min={ paddingLeftMin }
					max={ paddingLeftMax }
			...
			{ paddingEnableVertical && (
				<RangeControl
					label={ __( 'Padding Vertical', 'qodeblock' ) }
			...
			{ paddingEnableHorizontal && (
				<RangeControl
					label={ __( 'Padding Horizontal', 'qodeblock' ) }
