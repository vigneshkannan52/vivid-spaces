...
export default function MarginSettings( props ) {
	...
	return (
		<Fragment>
			{ marginEnableTop && (
				<RangeControl
					label={ marginTopLabel ? marginTopLabel : __( 'Margin Top', 'qodeblock' ) }
					value={ marginTop }
					min={ marginTopMin }
					max={ marginTopMax }
			...
			{ marginEnableRight && (
				<RangeControl
					label={ marginRightLabel ? marginRightLabel : __( 'Margin Right', 'qodeblock' ) }
					value={ marginRight }
					min={ marginRightMin }
					max={ marginRightMax }
			...
			{ marginEnableBottom && (
				<RangeControl
					label={ marginBottomLabel ? marginBottomLabel : __( 'Margin Bottom', 'qodeblock' ) }
					value={ marginBottom }
					min={ marginBottomMin }
					max={ marginBottomMax }
			...
			{ marginEnableLeft && (
				<RangeControl
					label={ marginLeftLabel ? marginLeftLabel : __( 'Margin Left', 'qodeblock' ) }
					value={ marginLeft }
					min={ marginLeftMin }
					max={ marginLeftMax }
			...
			{ marginEnableVertical && (
				<RangeControl
					label={ marginVerticalLabel ? marginVerticalLabel : __( 'Margin Vertical', 'qodeblock' ) }
			...
			{ marginEnableHorizontal && (
				<RangeControl
					label={ marginHorizontalLabel ? marginHorizontalLabel : __( 'Margin Horizontal', 'qodeblock' ) }
