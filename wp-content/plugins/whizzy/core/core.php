...
class whizzy {
	...
	static function defaults() {
		if ( self::$defaults === null ) {
			self::$defaults = include self::corepath() . 'defaults.php';
		}
	...
	static function form( $config, $processor ) {
		$form = self::instance( 'WhizzyForm', $config );
	...
	/**
	 * @param array configuration
	 * @return WhizzyProcessor
	 */
	static function processor( $config ) {
		return self::instance( 'WhizzyProcessor', $config );
	}
	 ...
	 * @throws Exception
	 */
	static function callback( $key, WhizzyMeta $meta ) {
	...
	protected static $textdomain = 'whizzy_txtd';
