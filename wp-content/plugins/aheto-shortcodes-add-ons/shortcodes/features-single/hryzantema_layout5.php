		...
		<div class="aheto-features-block__wrap">
            ...
            <div class="aheto-features-block__content">
                <?php if ( !empty($s_heading)  ) : ?>
                    <<?php echo esc_attr($hryzantema_heading_tag) ?>  class="aheto-content-block__title"><?php echo esc_html($s_heading); ?></<?php echo  esc_attr($hryzantema_heading_tag) ?> >
                <?php endif; ?>
...
if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) :  
	?>
	<link href="<?php echo $shortcode_dir . 'assets/css/hryzantema_layout5.css'?>" rel="stylesheet">
	<?php
endif;