					...
					<?php foreach ( $left_links as $index => $link ) : ?>
						...
						<div class="aheto-navbar--item">
							...
							if ( $link['type_link'] == 'socials' ) {
								...
								echo Helper::get_social_networks_list( '<a class="aheto-navbar--item-link icon" href="%1$s" target="_blank"><i class="' . $font_icon . '%2$s"></i></a>', 'left_links_', $link );
					...
					<?php foreach ( $right_links as $index => $link ) : ?>
						...
						<div class="aheto-navbar--item">
							...
							if ( $link['type_link'] == 'socials' ) {
								...
								echo Helper::get_social_networks_list( '<a class="aheto-navbar--item-link icon" href="%1$s" target="_blank"><i class="' . $font_icon . '%2$s"></i></a>', 'right_links_', $link );
