...
function rela_navigation_layout2($shortcode)
{
    ...
    aheto_addon_add_dependency(['max_width', 'mob_logo','add_scroll_logo', 'scroll_logo', 'add_mob_scroll_logo', 'scroll_mob_logo', 'transparent', 'type_logo', 'logo', 'text_logo', 'mobile_menu_width' ], ['rela_layout2'], $shortcode);
