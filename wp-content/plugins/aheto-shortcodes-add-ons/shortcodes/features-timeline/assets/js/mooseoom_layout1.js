;(function ($, window, document, undefined) {
    ...
    let timelines = $('.aheto-timeline--mooseoom-modern'),
    ...
    */
    ...
    function checkMQ() {
        ...
        return window.getComputedStyle(document.querySelector('.aheto-timeline--mooseoom-modern'), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
    }
