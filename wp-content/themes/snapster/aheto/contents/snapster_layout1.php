...
$this->add_render_attribute('wrapper', 'class', 'aheto-contents--snapster-faq');
...
$sc_dir = SNAPSTER_T_URI . '/aheto/contents/';
$custom_css = Helper::get_settings('general.custom_css_including');
$custom_css = (isset($custom_css) && !empty($custom_css)) ? $custom_css : false;
if (empty($custom_css) || ($custom_css == "disabled")) {
    wp_enqueue_style('snapster-contents-layout1', $sc_dir . 'assets/css/snapster_layout1.css', null, null);
}
?>
    ...
    foreach ($faqs as $key => $item) :
        ...
        <div class="aheto-contents__item <?php echo esc_attr($class_active); ?>">
            <?php if (!empty($item['title'])) : ?>
                <h5 class="aheto-contents__title js-accordion"><?php echo esc_html($item['title']); ?>
                    <i class="el arrow_carrot-down"></i>
                </h5>
            <?php endif; ?>
